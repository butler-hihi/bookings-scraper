...
class WhatsAppNotifier:
    ...
    def send_whatsapp(self, message: str) -> bool:
        ...
        try:
            ...
            message_payload = {"text": message, "channel": self.channel}

            # Send via the WhatsApp channel
            result = gateway.post(f"/channels/{self.channel}/messages", data=message_payload)
    ...
    def send_availability_update(
        self, trail_name: str, newly_available: list, newly_unavailable: list, checked_at: str
    ) -> bool:
