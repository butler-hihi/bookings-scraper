...
class TestDatabase(unittest.TestCase):
    ...
    def test_save_availability(self):
        ...
        record_id = save_availability(trail_name="otter", date="2026-04-01", available=True)
        self.assertIsNotNone(record_id)
        self.assertIsInstance(record_id, int)

    def test_get_availability(self):
        """Test retrieving availability records."""
        save_availability(trail_name="otter", date="2026-04-01", available=True)
    ...
    def test_update_availability(self):
        ...
        # Update
        save_availability(trail_name="otter", date="2026-04-01", available=False)
